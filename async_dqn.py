...
def actor_learner_thread(thread_id, env, session, graph_ops, num_actions, summary_ops, saver):
    ...
    print
    "Starting thread ", thread_id, "with final epsilon ", final_epsilon
...
def evaluation(session, graph_ops, saver):
    ...
    print
    "Restored model weights from ", FLAGS.checkpoint_path
    monitor_env = gym.make(FLAGS.game)
    monitor_env.monitor.get_start_cmd(FLAGS.eval_dir + "/" + FLAGS.experiment + "/eval")
