...
def actor_learner_thread(num, env, session, graph_ops, summary_ops, saver):
    ...
    env = TrafficSim(sumo_env=env, cross_num=CROSS_NUM, cross_status=CROSS_STATUS,
